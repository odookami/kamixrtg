...
class ReportStockCardReportXlsx(models.AbstractModel):
    ...
    def _get_ws_params(self, wb, data, product):
        ...
        stock_card_template = {
            ...
            "4_expiration_date_char": {
                "header": {"value": "Expired Date"},
                "data": {
                    "value": self._render("expiration_date_char"),
                    "format": FORMATS["format_tcell_left"],
                },
                "width": 25,
            },
        ...
        for line in product_lines:
            ...
            row_pos = self._write_line(
                ...
                render_space={
                    ...
                    "lot_id": line.lot_name or "",
                    "expiration_date_char": line.expiration_date_char or "",
